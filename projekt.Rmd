...
shinyAppDir("shiny1", options=list(width="100%", height="590"))
...
Spodnji graf prikazuje število smrtnih žrtev glede na povprečen BDP. Na tem konkretnem primeru lahko vidim, da moja predpostavka ne drži, saj ima npr.Texas kljub visokem povprečnem BDP, večje število smrtnih žrtev. Tukaj bi potem morala 
pogledati še stopnjo škode, za katero pa ni danega podatka.
Primerljii sta le Illinois in Indiana. Indiana ima nižji povprečni BDP, vendar enako število smrtnih žrtev in škodo kot Illionis, tako da tukaj bi lahko rekli, da povprečni BDP nima nikakršnega vpliva.
