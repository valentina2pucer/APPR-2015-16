...
Spodnji graf prikazuje število smrtnih žrtev glede na povprečen BDP. Na tem konkretnem primeru lahko vidim,da ima npr.Texas kljub visokem povprečnem BDP, večje število smrtnih žrtev. Tukaj bi potem morala 
pogledati še stopnjo škode, za katero pa ni danega podatka.
Primerljii sta le Illinois in Indiana. Indiana ima nižji povprečni BDP in vidimo, da je tudi število smrtnih žrtev nižje kot pri Illinois, kar potrdi mojo predpodstavko.
...
Naslednji graf prikazuje odvisnost povprečnega BDP-ja glede na škodo, ki je nastala v naravni nesreči "Tornado". Iz danega grafa lahko vidim, da je škoda, ki je nastala v neki naravni nesreči  skladu z razmerjem glede na BDP z nekaterimi izjemami, kar potrjujeto to, da bi morali upoštevati tudi druge dejavnike(npr. v kašnem obsegu oz.kako huda je bila naravna nesreča).
